...
?>
                ...
                <div class="col-4 mainList <?echo $arSection['CODE'];?> decisionsSection <?if ($count==0)echo'active';$count++;?>">
                  ...
                  <img class='decisionGif' src="<?=CFile::GetPath($arResult["SECTION_USER_FIELDS"]["UF_DECGIF"]);?>" alt="">
                   <h3 class="decisionName"><?echo $arSection['NAME'];?></h3>
                    <div class="decisionInCatList" style="color:white;">
	...
	?>
                            <p class='decisionMain'>
                                  <?echo $arItem["NAME"];?>
								</p>
                        <?endif;?>
                        <?endforeach;?>
                    </div>
                    <a class="btn" href="/decisions/<?echo $arSection['CODE'];?>/">
                       ВСЕ РЕШЕНИЯ
                    </a>
                </div>
                <?endforeach;?>
